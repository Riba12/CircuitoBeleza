            ...
            <div className="bg-marrom-500 flex h-dvh text-white">
                ...
                <section className="flex flex-row font-cocosharp w-full h-full md:w-[960px] md:h-dvh 2xl:w-[1440px] ">
                    <div className="flex flex-col w-1/2">
                        <div className="relative place-content-center pl-2 h-2/3">
                    ...
                    <div className="w-1/2 flex flex-col justify-around md:justify-evenly">
                        ...
                        <div className="animate-slideInText w-4/5 text-base pt-2 md:text-3xl 2xl:text-5xl">
                            Centro técnico de capacitação e aperfeiçoamento profissional.
                        </div>
                        <div className="animate-slideInText w-4/5 text-base md:text-3xl 2xl:text-5xl">
